...
<div ng-init="getNxAutomobileList()" class="container" style="width: 1000px;">
		...
		<table width="100%">
		<tr>
			<td align="left">&nbsp;&nbsp;&nbsp;&nbsp;Automobiles Services in Noida Extension</td>
				...
				<table style=" border-spacing: 105px;" cellpadding="100">
					<tr>
						...
						<td valign="top" width="60%" style="text-align:left;">
									...
									<%-- <img src="<c:url value="/img/common/phone.png"/>"class="img-rounded" width="20" height="20"> {{ nxAutomobile.contactNumber}} --%> 
									</h5> 
