...
<div ng-init="getNxSearchSiteList()" class="container" style="width: 1000px;">
		</br>
		<table width="100%">
		<tr>
			<td align="left">&nbsp;&nbsp;&nbsp;&nbsp;You searched for '{{searchString}}'</td>
			<td align="right">Filter Result:&nbsp;<input type="test" size="50" placeholder="Filter here.." ng-model="searchFilter"></td>
		</tr>
		</table>
