...
<div style="padding-top:  10px;">
	<div id="myCarousel" class="carousel slide" data-ride="carousel" data-interval="3000" >
		...
		<div class="carousel-inner" align="center" ng-if="advertiseSection=='Home' || advertiseSection=='SearchSite'
		  ...
		  advertiseSection=='customerCare' || advertiseSection=='privacyPolicy'" >
				...
				<div class="item">
					<a class="button" ng-href="tel:09319241740">
						<img style='height: 17%; width: 100%' src="<c:url value="/img/advertisement/adv_UMgroupAdvNoidaGSTReady.png"/>" >
					</a>
				</div>
				<div class="item">
					<a class="button" ng-href="https://timesofindia.indiatimes.com/city/noida/noida-metro-gets-nod-to-build-second-greater-noida-corridor/articleshow/72357664.cms" target="_blank">
						<img style='height: 17%; width: 100%' src="<c:url value="/img/advertisement/adv_metroAquaToNoidaX.png"/>" >
					</a>
				</div>
				<div class="item">
				...
				<div class="item">
					<a style="cursor: pointer" ng-click="getMyAction('Metro Bus'); goToTop()"> 
						<img style='height: 17%; width: 100%' src="<c:url value="/img/advertisement/adv_MetroBusService.png"/>"  >
					</a>
				</div>
				<div class="item">
					<a style="cursor: pointer" href="https://www.milkbasket.com/" target="_blank"> 
						<img style='height: 17%; width: 100%' src="<c:url value="/img/advertisement/adv_milkBasket.JPG"/>" >
					</a>
				</div> 
				<div class="item">
					<a style="cursor: pointer" href="http://www.sarvottamnoida.com/" target="_blank"> 
						<img style='height: 17%; width: 100%' src="<c:url value="/img/advertisement/adv_sarvottamInternationalSchool.png"/>" >
					</a>
				</div> 
		</div>
		<div class="carousel-inner" align="center" ng-if="advertiseSection=='Restaurants'">
				<div class="item active">
					<img style='height: 17%; width: 100%' src="<c:url value="/img/restaurant/restaurant_advertise1.jpeg"/>" >
				</div>
				<div class="item">
					<a class="button" ng-href="tel:08800587117">
						<img style='height: 17%; width: 100%' src="<c:url value="/img/advertisement/adv_AdvertiseYourShopHere.png"/>" >
		...
		<div class="carousel-inner" align="center" ng-if="advertiseSection=='Hospitals'">
				<div class="item active">
					<img style='height: 17%; width: 100%' src="<c:url value="/img/hospital/hospital_advertise1.jpeg"/>" >
				</div>
				<div class="item">
					<a class="button" ng-href="tel:08800587117">
						<img style='height: 17%; width: 100%' src="<c:url value="/img/advertisement/adv_AdvertiseYourShopHere.png"/>" >
		...
		<div class="carousel-inner" align="center" ng-if="advertiseSection=='Pharmacy'">
				<div class="item active">
					<img style='height: 17%; width: 100%' src="<c:url value="/img/pharmacy/pharmacy_advertise1.jpeg"/>" >
				</div>
				<div class="item">
					<a class="button" ng-href="tel:08800587117">
						<img style='height: 17%; width: 100%' src="<c:url value="/img/advertisement/adv_AdvertiseYourShopHere.png"/>" >
		...
		<div class="carousel-inner" align="center" ng-if="advertiseSection=='Path Labs'">
				<div class="item active">
					<img style='height: 17%; width: 100%' src="<c:url value="/img/pathLabs/pathLabs_advertise1.jpeg"/>" >
				</div>
				<div class="item">
					<a class="button" ng-href="tel:08800587117">
						<img style='height: 17%; width: 100%' src="<c:url value="/img/advertisement/adv_AdvertiseYourShopHere.png"/>" >
		...
		<div class="carousel-inner" align="center" ng-if="advertiseSection=='Rent & Sale'">
				<div class="item active">
					<a> 
						<img style='height: 17%; width: 100%' src="<c:url value="/img/advertisement/adv_Rent&Sale.png"/>"  >
					</a>
				</div>
				<div class="item">
					<a class="button" ng-href="tel:08800587117">
		...
		<div class="carousel-inner" align="center" ng-if="advertiseSection=='Daily Needs'">
				<div class="item active">
					<a class="button" ng-href="tel:09990098106">
						<img style='height: 17%; width: 100%' src="<c:url value="/img/dailyNeeds/dailyNeeds_advertise1.jpeg"/>" >
					</a>
				</div>
				<div class="item">
					<a class="button" ng-href="tel:08800587117">
		...
		<div class="carousel-inner" align="center" ng-if="advertiseSection=='Schools'">
				<div class="item active">
					<img style='height: 17%; width: 100%' src="<c:url value="/img/school/school_advertise1.jpeg"/>" >
				</div>
				<div class="item">
					<a class="button" ng-href="tel:08800587117">
						<img style='height: 17%; width: 100%' src="<c:url value="/img/advertisement/adv_AdvertiseYourShopHere.png"/>" >
		...
		<div class="carousel-inner" align="center" ng-if="advertiseSection=='Play Schools'">
				<div class="item active">
					<img style='height: 17%; width: 100%' src="<c:url value="/img/playSchools/playSchools_advertise1.jpeg"/>" >
				</div>
				<div class="item">
					<a class="button" ng-href="tel:08800587117">
						<img style='height: 17%; width: 100%' src="<c:url value="/img/advertisement/adv_AdvertiseYourShopHere.png"/>" >
		...
		<div class="carousel-inner" align="center" ng-if="advertiseSection=='Taxi Services'">
				<div class="item active">
					<img style='height: 17%; width: 100%' src="<c:url value="/img/taxiService/taxiService_advertise1.jpeg"/>" >
				</div>
				<div class="item">
					<a class="button" ng-href="tel:08800587117">
						<img style='height: 17%; width: 100%' src="<c:url value="/img/advertisement/adv_AdvertiseYourShopHere.png"/>" >
		...
		<div class="carousel-inner" align="center" ng-if="advertiseSection=='Parlour & Salon'">
				<div class="item active">
					<img style='height: 17%; width: 100%' src="<c:url value="/img/personalCare/personalCare_advertise1.jpeg"/>" >
				</div>
				<div class="item">
					<a class="button" ng-href="tel:08800587117">
						<img style='height: 17%; width: 100%' src="<c:url value="/img/advertisement/adv_AdvertiseYourShopHere.png"/>" >
		...
		<div class="carousel-inner" align="center" ng-if="advertiseSection=='Automobiles'">
				<div class="item active">
					<img style='height: 17%; width: 100%' src="<c:url value="/img/automobiles/automobiles_advertise1.jpeg"/>" >
				</div>
				<div class="item">
					<a class="button" ng-href="tel:08800587117"><img style='height: 17%; width: 100%' src="<c:url value="/img/advertisement/adv_AdvertiseYourShopHere.png"/>" ></a>
				</div>
		</div>
		...
		<div class="carousel-inner" align="center" ng-if="advertiseSection=='Boutique'">
				<div class="item active">
					<img style='height: 17%; width: 100%; cursor: pointer' src="<c:url value="/img/boutique/boutique_advertise1.jpeg"/>" >
				</div>
				<div class="item">
					<a class="button" ng-href="tel:08800587117">
						<img style='height: 17%; width: 100%' src="<c:url value="/img/advertisement/adv_AdvertiseYourShopHere.png"/>" >
		...
		<div class="carousel-inner" align="center" ng-if=" advertiseSection=='Toys' || advertiseSection=='Gifts'
						...
						|| advertiseSection=='Pandit Ji' || advertiseSection=='AC Service'
