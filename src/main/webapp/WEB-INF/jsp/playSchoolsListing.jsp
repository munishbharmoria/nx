...
<div style="padding-top: 20px;padding-left: 10px;padding-right: 10px;">
		<table width="100%">
			<tr>
				<td align="left">
					Play Schools in Noida Extension
				</td>
				<td align="right">
...
<div ng-init="getNxPlaySchoolList()" style="padding-top: 20px;padding-left: 10px;padding-right: 10px;">	
		<ul class="list-group" >
