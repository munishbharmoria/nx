...
<div style="padding-top: 20px;padding-left: 10px;padding-right: 10px;">
		<table width="100%">
			<tr>
				<td align="left">
					{{otherSelectedCategory}} in Noida Extension
				</td>
				<td align="right">
					Search:<input type="test" size="50" placeholder="search for {{otherSelectedCategory}}.." ng-model="searchFilter">
				</td>
			</tr>
		</table>
</div>

<div ng-init="getNxOtherCategoryList()" style="padding-top: 20px;padding-left: 10px;padding-right: 10px;">		
		<ul class="list-group" >
